        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _events.RaiseAsync(new UserLoginSuccessEvent(user.UserName, user.Id, user.DisplayName, clientId: context?.Client.ClientId));
                    if (context != null)
                    {
                        return Redirect(model.ReturnUrl);
                    }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (loginresult.Succeeded)
                    {
                        ...
                        await _events.RaiseAsync(new UserLoginSuccessEvent(checkuser.UserName, checkuser.Id, checkuser.DisplayName, clientId: context?.Client.ClientId));
