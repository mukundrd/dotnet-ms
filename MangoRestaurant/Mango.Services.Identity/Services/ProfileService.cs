...
namespace Mango.Services.Identity.Services
{
    public class ProfileService : IProfileService
    {
        ...
        public async Task GetProfileDataAsync(ProfileDataRequestContext context)
        {
            ...
            claims.Add(new Claim(IdentityModel.JwtClaimTypes.FamilyName, user.LastName));
            claims.Add(new Claim(IdentityModel.JwtClaimTypes.GivenName, user.FirstName));
            claims.Add(new Claim(IdentityModel.JwtClaimTypes.Name, user.DisplayName));
